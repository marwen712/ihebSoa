...
cot:any
scroll:any
  constructor(private render:Renderer2 ,public crud:CrudService, private  route:ActivatedRoute,private sanitizer: DomSanitizer) { }
  ...
  this.crud.id2=Number(this.route.snapshot.paramMap.get('id'))
